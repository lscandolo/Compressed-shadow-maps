...
void ImGui::ProgressBar(float fraction, const ImVec2& size_arg, const char* overlay, const ImVec4& color)
{
	ImColor barColor = color.w < 0 ? GetColorU32(ImGuiCol_PlotHistogram) : ImColor(color);
    ...
    RenderRectFilledRangeH(window->DrawList, bb, barColor, 0.0f, fraction, style.FrameRounding);
